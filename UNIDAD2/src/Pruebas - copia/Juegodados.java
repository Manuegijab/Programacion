...
String[] mostrarhistorial( int numerodevecesjugado,int numeroapuesta,int sumadados,int dineroganacias) {
	...
	if(numeroapuesta==sumadados) {
	String datos= "En la" + numerodevecesjugado +"jugada apostó al valor "+ numeroapuesta+" y sumó "+sumadados+ "ganando " + dineroganacias + ".";
	}
	else {
	String datos= "En la" + numerodevecesjugado +"jugada apostó al valor "+ numeroapuesta+" y sumó "+sumadados+ "perdiendo " + dineroganacias + ".";
	}
